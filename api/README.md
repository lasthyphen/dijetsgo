...
Protobuf files are hosted at [https://buf.build/lasthyphen/dijetsgo](https://buf.build/lasthyphen/dijetsgo) and can be used as dependencies in other projects.
