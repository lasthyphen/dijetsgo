...
## [v1.7.5](https://github.com/lasthyphen/dijetsgo/releases/tag/v1.7.5)

This version is backwards compatible to [v1.7.0](https://github.com/lasthyphen/dijetsgo/releases/tag/v1.7.0). It is optional, but encouraged.
...
## [v1.7.4](https://github.com/lasthyphen/dijetsgo/releases/tag/v1.7.4)
...
## [v1.7.3](https://github.com/lasthyphen/dijetsgo/releases/tag/v1.7.3)
...
## [v1.7.2](https://github.com/lasthyphen/dijetsgo/releases/tag/v1.7.2)
...
## [v1.7.1](https://github.com/lasthyphen/dijetsgo/releases/tag/v1.7.1)

This update is backwards compatible with [v1.7.0](https://github.com/lasthyphen/dijetsgo/releases/tag/v1.7.0). Please see the expected update times in the v1.7.0 release.
...
## [v1.7.0](https://github.com/lasthyphen/dijetsgo/releases/tag/v1.7.0)
...
## [v1.6.5](https://github.com/lasthyphen/dijetsgo/releases/tag/v1.6.5)

This version is backwards compatible to [v1.6.0](https://github.com/lasthyphen/dijetsgo/releases/tag/v1.6.0). It is optional, but encouraged.
...
## [v1.6.4](https://github.com/lasthyphen/dijetsgo/releases/tag/v1.6.4)
...
## [v1.6.3](https://github.com/lasthyphen/dijetsgo/releases/tag/v1.6.3)
