...
func (b *builder) NewBaseTx(
	...
	djtx.SortTransferableOutputs(outputs, Codec) // sort the outputs

	return &avm.BaseTx{BaseTx: djtx.BaseTx{
...
func (b *builder) NewImportTx(
	...
	*avm.ImportTx,
	...
	djtx.SortTransferableOutputs(outputs, Codec)
	return &avm.ImportTx{
		BaseTx: avm.BaseTx{BaseTx: djtx.BaseTx{
			NetworkID:    b.backend.NetworkID(),
...
func (b *builder) spend(
	...
	djtx.SortTransferableOutputs(outputs, Codec) // sort the change outputs
