...
import (
	...
	"github.com/lasthyphen/dijetsgo/api/auth"
	...
	"github.com/lasthyphen/dijetsgo/chains"
	...
	"github.com/lasthyphen/dijetsgo/ipcs"
	"github.com/lasthyphen/dijetsgo/message"
	"github.com/lasthyphen/dijetsgo/network"
	"github.com/lasthyphen/dijetsgo/network/throttling"
	...
	"github.com/lasthyphen/dijetsgo/snow/uptime"
	"github.com/lasthyphen/dijetsgo/snow/validators"
	"github.com/lasthyphen/dijetsgo/utils"
	...
	"github.com/lasthyphen/dijetsgo/utils/profiler"
	"github.com/lasthyphen/dijetsgo/utils/timer"
	...
	"github.com/lasthyphen/dijetsgo/vms/propertyfx"
	"github.com/lasthyphen/dijetsgo/vms/rpcchainvm"
	"github.com/lasthyphen/dijetsgo/vms/secp256k1fx"

	ipcsapi "github.com/lasthyphen/dijetsgo/api/ipcs"
)
...
func (n *Node) initChainManager(djtxAssetID ids.ID) error {
	...
	errs.Add(
		...
		n.Config.VMManager.RegisterFactory(constants.EVMID, &dijeth.Factory{}),
